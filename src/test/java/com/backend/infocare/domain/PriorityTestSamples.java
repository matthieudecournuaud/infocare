...
public class PriorityTestSamples {
    ...
    public static Priority getPrioritySample1() {
        return new Priority().id(1L).name("name1").description("description1").colorCode("colorCode1");
    }

    public static Priority getPrioritySample2() {
        return new Priority().id(2L).name("name2").description("description2").colorCode("colorCode2");
    }
